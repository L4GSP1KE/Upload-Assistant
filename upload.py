        ...
        try:
            with open(f"{base_dir}/tmp/{os.path.basename(path)}/meta.json") as f:
                ...
                for key, value in saved_meta.items():
                    overwrite_list = ['trackers', 'dupe', 'debug', 'anon', 'category', 'type', 'screens', 'nohash', 'manual_edition', 'imdb', 'tmdb_manual', 'mal', 'manual', 'ptp', 'blu', 'no_aka', 'client', 'desclink', 'descfile']
